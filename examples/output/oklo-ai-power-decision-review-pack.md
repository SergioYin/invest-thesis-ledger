...
- Command: `python -m invest_thesis_ledger decision-review-pack examples/oklo-ai-power.json --output oklo-ai-power-decision-review-pack.md --json-output oklo-ai-power-decision-review-pack.json`
- Workflow: single-ledger decision-review-pack
- Input Ledger: examples/oklo-ai-power.json
- Markdown Output: oklo-ai-power-decision-review-pack.md
