# Broker Matrix: Oklo AI Power Demand Thesis
...
| --- | --- | --- | --- | --- | --- | --- |
| B1 | Grid Infrastructure Desk | constructive | watch for contracted megawatts | 2026-05-10 | Firm clean power scarcity could support premium economics if Oklo converts interest into binding contracts. | [S1], [S2] |
| B2 | Regulatory Risk Desk | cautious | no target until licensing timeline is dated | 2026-05-11 | Commercial upside remains hard to underwrite before licensing cadence and financing runway are clearer. | [S3] |
