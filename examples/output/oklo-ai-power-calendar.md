# Catalyst Calendar: Oklo AI Power Demand Thesis
...
### CAT2: Material licensing update with a clear review timeline.
...
### CAT1: Signed commercial power purchase agreement with credible counterparty.
...
### CAT3: Capital raise or partnership that reduces funding risk.

- Date: not specified
- Window: next financing update
- Status: watch
- Sources: [S1]
