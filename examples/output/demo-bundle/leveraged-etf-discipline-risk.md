# Risk Report: Leveraged ETF Discipline Ledger
...
- Severity: high
- Probability: high
- Tags: leverage, volatility, path-dependency
- Mitigation: Use only with explicit holding-period limit and daily review.
- Sources: [S1], [S2]

### R2: Oversized exposure

- Severity: high
- Probability: medium
- Tags: sizing, leverage
- Mitigation: Cap notional exposure before order entry.
- Sources: [S1]
