# History: Leveraged ETF Discipline Ledger
...
- Summary: Created a discipline ledger for tactical leveraged ETF use with explicit sizing, event, and exit constraints.
- Drift: none recorded
- Sources: [S1], [S2]
